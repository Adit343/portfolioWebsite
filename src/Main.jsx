  ...
  return (
    ...
    className='Main' id="mainy">
      <div className="main_left">
        ...
        <div className="logos">
        <a href="https://github.com/Adit343" target="_blank" rel="noreferrer"><img src={github} alt=""  /></a>
        <a href="https://www.linkedin.com/in/adit-shah-720639222/" target="_blank" rel="noreferrer"><img src={linked_in} alt=""></img></a>
        </div>
        </div>
        <div className="flex1">
        <a href="mailto:shahadit68@gmail.com"><button className='buttonc'>E-Mail Me</button></a>
        <button onClick={() => window.open("https://drive.google.com/file/d/1X4Q7k9kK6bLJ2d2xm7WncVv47SDvytN6/view?usp=sharing", "_blank")} className='buttonb'>Resume</button>
        </div>
      </div>
